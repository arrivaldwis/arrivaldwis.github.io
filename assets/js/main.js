...
function buildEuropassPDF(photoData) {
	try {
		...
		var europassWork = [
			...
			{ period: '04/2024 \u2013 05/2026', title: 'Coordinator of AI Development', employer: 'PT Neuronworks Indonesia', location: 'Bandung, Indonesia', desc: 'Leading AI/ML research, development, and application. Coordinating development teams and managing AI project lifecycles.' },
			{ period: '01/2023 \u2013 05/2026', title: 'National Jury Team', employer: 'WorldSkills Indonesia', location: 'IT Software Solution for Business', desc: 'Preparing competitors, creating problem statements, developing solutions, and evaluating according to WorldSkills International standards.' },
